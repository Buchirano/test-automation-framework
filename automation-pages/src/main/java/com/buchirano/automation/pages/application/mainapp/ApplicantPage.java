...
/**
 * Page class for the Applicant Details screen within CaseManagementApp.
 *
...
public class ApplicantPage extends LightningBasePageClass {
    ...
    public final String taxIdSelector = "//*[@data-id='vetSSShow']//input";
    ...
    public void enterPersonalInformation(String taxId, String maritalStatus, String serviceNumber,
    ...
    public void enterAllApplicantDetails(String firstName, String middleName, String lastName,
        ...
        enterPersonalInformation(randomTaxId(), "Married", "4444", "22", "Maiden", deceased, dateOfDeath, "Mar 1, 1960", "Sarasota", "Florida", "(888) 888-8888", "automation-test@email.com");
    ...
    public void enterApplicantSearchValues(String firstName, String middleName, String lastName,
            String taxId, String birthDate, String icn, String edipi, String gender, String phone,
        ...
        searchModal.taxIdField().sendKeys(taxId);
    ...
    public void clearApplicantSearchFields() {
        getFirstNameInput().clear(); getMiddleNameInput().clear(); getLastNameInput().clear(); getTaxIdInput().clear();
    ...
    public void openApplicantSearchModalAndSelect(String firstName, String middleName, String lastName,
        ...
        enterApplicantSearchValues(firstName, middleName, lastName, taxId, birthDate, icn, edipi, gender, phone, mothersMaidenName, birthCity, birthState);
    ...
    public List<AutomatedObject> listOfAllFields() {
        return List.of(getFirstNameInput(), getMiddleNameInput(), getLastNameInput(), getSuffixDropdown(),
                ...
                getTaxIdInput(), getServiceNumberInput(), getClaimNumberInput(), getMaritalStatusDropdown(),
