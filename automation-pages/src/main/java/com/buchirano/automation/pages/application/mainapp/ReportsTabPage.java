...
/**
 * Page class for the Reports tab within the CaseManagementApp application.
 *
...
public class ReportsTabPage extends LightningBasePageClass {
    ...
    private final MainAppGeneralNavigationPage navigate = new MainAppGeneralNavigationPage();
