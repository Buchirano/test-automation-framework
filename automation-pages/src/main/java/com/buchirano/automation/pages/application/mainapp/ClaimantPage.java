...
public class ClaimantPage extends LightningBasePageClass {
    ...
    public final String relationshipToBeneficiarySelector = "//*[@data-id='relationshipToVeteran']//button";
    ...
    public final String taxIdSelector = "//*[@data-id='decedentSsnShow']//input";
    ...
    public AutomatedObject getRelationshipToBeneficiaryDropdown() { scrollIntoView(relationshipToBeneficiarySelector); return getElementByXPath(relationshipToBeneficiarySelector); }
    ...
    public AutomatedObject getTaxIdInput() { scrollIntoView(taxIdSelector); return getElementByXPath(taxIdSelector); }
    ...
    public void selectRelationshipToBeneficiary(String relationshipToBeneficiary) {
        if (relationshipToBeneficiary == null) return;
        waitForVisibility(relationshipToBeneficiarySelector);
        scrollIntoView(relationshipToBeneficiarySelector);
        getRelationshipToBeneficiaryDropdown().click();
        WebElement element = driver.findElement(By.xpath(
                ".//*[@aria-label='Relationship to Veteran']//span[@title = '" + relationshipToBeneficiary + "']"));
    ...
    public void enterPersonalInformation(String firstName, String middleName, String lastName,
            String suffix, String taxId, String gender, String maritalStatus,
        ...
        fillInputField(getTaxIdInput(), taxId);
    ...
    public void inputTaxId(String taxId) { fillInputField(getTaxIdInput(), taxId); }
    ...
    public List<AutomatedObject> listOfAllFields() {
        ...
        if (isForeign) {
            return List.of(getRelationshipToBeneficiaryDropdown(), getFirstNameInput(),
