 ...
 * for the shared Availability and Schedule modal within the ResourcePortal application.
 *
...
public class ModalClass extends LightningBasePageClass {
    ...
    public void createNewTimeslot(TimeslotType timeslotType, String description, Impact impact,
        ...
        PortalGeneralNavigationPage navigation = new PortalGeneralNavigationPage();
