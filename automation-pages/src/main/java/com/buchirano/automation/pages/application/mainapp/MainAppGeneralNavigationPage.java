 ...
 * for the CaseManagementApp application.
 *
 ...
 *
 * <p><b>Application:</b> CaseManagementApp</p>
 * <p><b>Layer:</b> Page Object (Application — Navigation)</p>
 */
public class MainAppGeneralNavigationPage extends LightningBasePageClass {

    // ========================== Dependent Page Objects ==========================

    private final StartPage startScreen = new StartPage();
    private final ApplicantPage applicantScreen = new ApplicantPage();
    ...
    public void clickApplicantChevron() {
    ...
    public void goToApplicantScreen() {
    ...
    /** Populates all required fields on the Applicant Details screen. */
    public void populateApplicantScreen() {
        fillInputField(applicantScreen.getFirstNameInput(), "AutomatedVetFirst");
        fillInputField(applicantScreen.getLastNameInput(), "Test Vet");
        pageScrollDown();
        selectDropdownOption(applicantScreen.getMilitaryStatusDropdown(), "VETERAN");
        selectDropdownOption(applicantScreen.getServiceEligibilityDropdown(), "Yes");
        waitForSalesforceLoad();
    }
    ...
    public void populateClaimantScreen() {
        String taxId = randomTaxId();
        claimant.selectRelationshipToBeneficiary("WIFE");
        claimant.enterPersonalInformation("Populate", "ClaimantScreen", "Automation",
                "--None--", taxId, "Female", "Married", "(888)888-888", "AutomationClaimant@email.com");
    ...
    public void populatePersonalRepresentativeScreen() {
        ...
        personalRep.enterAdditionalFields("HUSBAND", personalRep.randomTaxId(), "7278675309",
