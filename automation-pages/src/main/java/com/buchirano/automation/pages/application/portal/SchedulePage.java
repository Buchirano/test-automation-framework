 ...
 * for the Schedule screen within the ResourcePortal resource management record.
 *
...
public class SchedulePage extends LightningBasePageClass {
    ...
    private final PortalGeneralNavigationPage navigation = new PortalGeneralNavigationPage();
