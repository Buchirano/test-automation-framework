 ...
 * for the Decedent Search modal within CaseManagementApp.
 *
...
public class DecedentSearchModalPage extends LightningBasePageClass {
    ...
    public String customBossIcon = "//lightning-badge[.='PRIMARY']";
    ...
    public AutomatedObject getTaxIdField() { return getElementBy("data-id", "cemeteryPageModalSSN"); }
