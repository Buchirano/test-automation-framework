...
/**
 * Page class for the Start screen of CaseManagementApp.
 *
...
public class StartPage extends LightningBasePageClass {
    ...
    public String beneficiaryID = "//*[@data-id='cemeteryPageModalVeteranId']//input";
    ...
    private final String salesforceBossIcon = "SECONDARY";
    ...
    public AutomatedObject getBeneficiaryID() { return getElementByXPath(beneficiaryID); }
    ...
    public void enterDecedentSearchValues(String firstName, String middleName, String lastName,
            String taxId, String birthDate, String deathDate, String serviceNumber, String id) {
        ...
        decedentSearch.getTaxIdField().sendKeys(taxId);
    ...
    public void clearDecedentSearchFields() {
        ...
        decedentSearch.getLastNameField().clear(); decedentSearch.getTaxIdField().clear();
    ...
    public void searchDecedentCaseAndSelect(String firstName, String middleName, String lastName,
        ...
        enterDecedentSearchValues(firstName, middleName, lastName, taxId, birthDate, deathDate, serviceNumber, id);
    ...
    public void inputBeneficiaryID(String id) { waitForSalesforceLoad(); getBeneficiaryID().clear(); getBeneficiaryID().sendKeys(id); waitForSalesforceLoad(); }
