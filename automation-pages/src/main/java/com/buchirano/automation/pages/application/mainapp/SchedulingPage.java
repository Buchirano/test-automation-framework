...
/**
 * Page class for the Scheduling Details screen within CaseManagementApp.
 *
...
public class SchedulingPage extends LightningBasePageClass {
    ...
    private final MainAppGeneralNavigationPage navigation = new MainAppGeneralNavigationPage();
