...
public class PersonalRepresentativePage extends BasePageClass {
    ...
    public AutomatedObject getSsn() { scrollIntoView(getInputXPathByDataId("nokSsnShow")); return getInputByDataId("nokSsnShow"); }
    ...
    public void enterAdditionalFields(String relation, String ssn, String phoneNumber, String email) {
        selectRelationshipToClaimant(relation);
        fillInputField(getPhoneNumber(), phoneNumber);
        fillInputField(getSsn(), ssn);
    ...
    public List<AutomatedObject> listOfAllFields() {
        return List.of(getFirstName(), getMiddleName(), getLastName(), getSuffixDropDown(),
                getRelationshipDropDown(), getSsn(), getPhoneNumber(), getEmail(),
